...
const LevelConfigs = [
	...
	},
	{
		level: 2, // level name
		limit: 2, // 限制的花色数，including `include`
		includes: ["beef"], // include specific imgs & count
		orders: [{ cuisine: "steak", duration: [15, 20] }],
		goal: 100,
		value: [
			{ x: -300, y: 298 },
			{ x: -300, y: 248 },
	...
	},
	{
		...
		includes: ["beef", "rice", "onion"], // include specific imgs & count
		orders: [
			{ cuisine: "riceball", duration: [10, 15] },
			{ cuisine: "steak", duration: [15, 20] },
		],
		goal: 130,
		value: [
			{ x: -300, y: 298 },
	...
	},
	{
		level: 4, // level name
		limit: 3, // 限制的花色数，including `include`
		includes: ["noodle", "rice", "onion"], // include specific imgs & count
		orders: [
			{ cuisine: "riceball", duration: [10, 15] },
			{ cuisine: "chaomian", duration: [16, 21] },
		],
		goal: 150,
		value: [
			{ x: -300, y: 298 },
